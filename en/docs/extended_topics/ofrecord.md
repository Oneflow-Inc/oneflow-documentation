...
In the following code, we will read `OFRecord` file generated in the above example. Call the `FromString` method to deserialize  to get the `OFRecord` object, and finally displays the data：
